...
namespace Drupal\Tests\trpcultivate\Kernel\Plugin\ChadoField\FieldType;
...
class ProjectGenusTypeCRUDTest extends ChadoTestKernelBase {
   ...
   * @var string
   */
  protected string $yaml_info_file = __DIR__ . '/ProjectGenusTypeCRUD-TestInfo.yml';
