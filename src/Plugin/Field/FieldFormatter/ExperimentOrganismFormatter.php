...
/**
 * Plugin implementation of the 'experiment_organism_formatter' field formatter.
 */
#[TripalFieldFormatter(
  id: 'experiment_organism_formatter',
...
class ExperimentOrganismFormatter extends ChadoFormatterBase {
